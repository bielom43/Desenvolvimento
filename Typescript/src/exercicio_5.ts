...
class lanchonete{
    ...
    public hamburguer_quantity!: number;
    public Batata_quantity!: number;
    public Refrigerante_quantity!: number;
    public Cerveja_quantity!: number;
    public Doce_quantity!: number;

    constructor(hamburguer_quantity: number, Batata_quantity: number, Refrigerante_quantity: number, Cerveja_quantity: number, Doce_quantity: number){
